---
title: 'Verifactu: Spanish Government postpones its implementation until 2027'
...
**However:**
If **your business issues invoices to your own clients** (for example, if you run a clinic, hair salon, workshop, etc.), then **Verifactu does affect you** as an invoice issuer. In that case:
...
1. **Learn about Verifactu requirements** and how they affect your business activity.
2. **Contact your invoicing software provider** and confirm they are working on a Verifactu-compatible solution.
3. **Review your current invoicing processes** to identify what changes you will need to implement.
